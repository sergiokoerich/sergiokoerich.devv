        ...
        <div className='h-screen bg-gray-950'>
          <div className='gap-5 slide-top animate-slide-top px-8 md:px-52 flex flex-col justify-center items-center md:flex-row md:justify-around md:py-44 py-32  '>
            ...
            <div className='mt-5 w-1/2 '>
                <h3 className='mb-5 font-normal text-3xl text-center text-Blue'>Sobre mim</h3>
                <h1 className='font-bold md:text-sm text-xs text-white md:mb-7 text-center justify-center md:w-auto '>
